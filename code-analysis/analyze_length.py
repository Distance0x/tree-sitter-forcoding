...
def generate_data(dataset, key, max_num=200, min_len=20, max_len=128, max_comment_num=10, max_def_num=5, cut_def=False, max_todo_num=3):
...
def main(dataset, dataset_key, temperature, tokenizer_name):
    ...
    data = generate_data(dataset, dataset_key, max_num=100000, min_len=20, max_len=512, max_comment_num=10, max_def_num=5, cut_def=True, max_todo_num=3)
...
tokenizer_name = "ByteDance-Seed/Seed-Coder-8B-Instruct"
temperature = 0.2
